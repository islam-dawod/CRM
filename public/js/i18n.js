...
const DICT = {
  he: {
    ...
    settings: 'הגדרות', ai: 'עוזר AI', clinic: 'מרפאה', logout: 'התנתקות', search: 'חיפוש...',
  ...
  ar: {
    ...
    settings: 'الإعدادات', ai: 'مساعد AI', clinic: 'العيادة', logout: 'تسجيل خروج', search: 'بحث...',
  ...
  en: {
    ...
    settings: 'Settings', ai: 'AI Assistant', clinic: 'Clinic', logout: 'Log out', search: 'Search...',
